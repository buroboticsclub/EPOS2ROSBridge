...
def generate_launch_description():
    ...
    controllers_yaml = PathJoinSubstitution([pkg, "config", "ros2_controllers_j3_jtc.yaml"])
    ...
    j3_trajectory_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=[
            "j3_trajectory_controller",
            "--controller-manager", "/controller_manager"
        ],
        output="screen",
    )
    ...
    return LaunchDescription([
        ...
        j3_trajectory_controller_spawner,
    ])